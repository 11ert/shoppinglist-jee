...
public class ShoppingItemBean implements Serializable {
	...
	@PersistenceContext(unitName = "shopping-persistence-unit", type = PersistenceContextType.EXTENDED)
	...
	public void paginate() {
		...
		CriteriaQuery<ShoppingItem> criteria = builder
				.createQuery(ShoppingItem.class);
		root = criteria.from(ShoppingItem.class);
		TypedQuery<ShoppingItem> query = this.entityManager
	...
	public List<ShoppingItem> getAll() {
		...
		return this.entityManager.createQuery(
				criteria.select(criteria.from(ShoppingItem.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final ShoppingItemBean ejbProxy = this.sessionContext
				.getBusinessObject(ShoppingItemBean.class);
